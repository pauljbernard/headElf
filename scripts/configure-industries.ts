...
async function setupDefaultConfiguration(system: IndustryActivationSystem) {
...
async function setupFortune500Configuration(system: IndustryActivationSystem) {
...
async function setupStartupConfiguration(system: IndustryActivationSystem) {
...
async function setupComprehensiveConfiguration(system: IndustryActivationSystem) {
...
async function resetConfiguration(system: IndustryActivationSystem) {
